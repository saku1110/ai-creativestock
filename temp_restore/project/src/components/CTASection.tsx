      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20">
          {secondaryCTAs.map((cta, index) => {
            ...
            return (
              <div key={index} className="glass-dark rounded-2xl p-6 sm:p-8 border border-white/10 hover-lift text-center">
                ...
                <button 
                  ...
                  className="w-full glass-effect border border-cyan-400/30 text-cyan-400 hover:text-white py-3 px-6 rounded-xl transition-all duration-300 font-bold hover:bg-cyan-400/10"
                >
                  詳細を見る
                </button>
              </div>
        ...
        {/* お問い合わせ情報 */}
        <div className="glass-effect rounded-3xl p-8 sm:p-12 border border-white/10 shadow-2xl">
