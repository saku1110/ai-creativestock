    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto mb-16 sm:mb-20">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`relative glass-dark rounded-2xl sm:rounded-3xl shadow-2xl border-2 transition-all duration-500 hover-lift ${
                  plan.isPopular 
              ...
              >
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="text-center mb-8 sm:mb-10">
                    {billingPeriod === 'annual' && (
                      <div className="mb-4">
                        <span className="glass-effect bg-green-500/10 border border-green-400/30 text-green-400 px-4 py-2 rounded-full text-sm font-bold">
                    ...
                    <div className="flex items-baseline justify-center">
                      ...
                      <span className="text-gray-400 ml-2 sm:ml-3 text-base sm:text-lg">
                        {billingPeriod === 'annual' ? '(年間一括)' : '/月'}
                      </span>
                    </div>
                    {billingPeriod === 'annual' && (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="glass-effect rounded-xl p-4 border border-orange-400/30 hover:bg-orange-400/5 transition-all">
                    ...
                    <div className="glass-effect rounded-xl p-4 border border-purple-400/30 hover:bg-purple-400/5 transition-all">
                      <div className="flex items-center space-x-3">
                    ...
                    <div className="glass-effect rounded-xl p-4 border border-cyan-400/30 hover:bg-cyan-400/5 transition-all">
                      <div className="flex items-center space-x-3">
        ...
        <div className="text-center mt-16 sm:mt-20">
          <div className="glass-effect rounded-2xl sm:rounded-3xl p-6 sm:p-8 max-w-4xl mx-auto border border-white/10">
