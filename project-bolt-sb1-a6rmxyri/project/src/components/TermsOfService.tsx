        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              本規約は、AI CreativeStock 運営事務局（以下「当運営事務局」といいます。）が提供するAI生成動画素材のサブスクリプションサービス「AI Creative Stock」（以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆様（以下「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-300 space-y-2">
              <li>利用登録を希望する方は、本規約に同意の上、当運営事務局の定める方法によって利用登録を申請し、当運営事務局がこれを承認することによって、利用登録が完了するものとします。</li>
              <li>当運営事務局は、利用登録の申請者に以下の事由があると判断した場合、利用登録の申請を承認しないことがあります。
                <ul className="list-disc list-inside ml-6 mt-2">
                  <li>利用登録の申請に際して虚偽の事項を届け出た場合</li>
                  <li>本規約に違反したことがある者からの申請である場合</li>
                  <li>その他、当運営事務局が利用登録を相当でないと判断した場合</li>
                </ul>
              </li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-300 space-y-2">
              <li>ユーザーは、本サービスの利用に対し、当運営事務局が別途定める利用料金を、当運営事務局が指定する方法により支払うものとします。</li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-300 space-y-2">
              <li>当運営事務局は、ユーザーに対し、本サービスにおいて提供する動画素材（以下「本素材」といいます。）を以下の範囲で利用することを許諾します。
                <ul className="list-disc list-inside ml-6 mt-2">
              ...
              <li>ユーザーは、本素材の著作権その他の権利が当運営事務局に帰属することを確認します。</li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-300 space-y-2">
              ...
              <li>犯罪行為に関連する行為</li>
              <li>当運営事務局、本サービスの他のユーザー、またはその他第三者のサーバーまたはネットワークの機能を破壊したり、妨害したりする行為</li>
              <li>当運営事務局のサービスの運営を妨害するおそれのある行為</li>
              <li>他のユーザーに関する個人情報等を収集または蓄積する行為</li>
              <li>不正アクセスをし、またはこれを試みる行為</li>
              <li>他のユーザーに成りすます行為</li>
              <li>本素材を単体で販売、再配布、またはストックフォトサービスに登録する行為</li>
              <li>その他、当運営事務局が不適切と判断する行為</li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-300 space-y-2">
              <li>当運営事務局は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。
                <ul className="list-disc list-inside ml-6 mt-2">
                  <li>本サービスにかかるコンピュータシステムの保守点検または更新を行う場合</li>
                  <li>地震、落雷、火災、停電または天災などの不可抗力により、本サービスの提供が困難となった場合</li>
                  <li>コンピュータまたは通信回線等が事故により停止した場合</li>
                  <li>その他、当運営事務局が本サービスの提供が困難と判断した場合</li>
                </ul>
              </li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-gray-300 space-y-2">
              <li>当運営事務局の債務不履行責任は、当運営事務局の故意または重過失によらない場合には免責されるものとします。</li>
              <li>当運営事務局は、本サービスに関して、ユーザーと他のユーザーまたは第三者との間において生じた取引、連絡または紛争等について一切責任を負いません。</li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300">
              当運営事務局は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300">
              当運営事務局は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該ユーザーは変更後の規約に同意したものとみなします。
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300">
              当運営事務局は、本サービスの利用によって取得する個人情報については、当運営事務局「プライバシーポリシー」に従い適切に取り扱うものとします。
            </p>
          </section>
